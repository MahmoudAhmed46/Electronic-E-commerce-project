        ...
        <div class="container mt-4 ml-5">
            <form>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control inp"  name="product_name" id="product_name" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control inp"  name="product_code" id="product_code" required>
                </div>
                <div class="form-group">
                    <label class="lbl-form">Product Price</label>
                    <input type="number" class="form-control inp"  name="product_price" id="product_price" required>
                </div>
                <div class="form-group">
                    <label class="lbl-form">Product Quantity</label>
                    <input type="number" class="form-control inp"  name="quantity" id="quantity" required>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.adminLayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laravel\project\resources\views/admin/products/edit-products.blade.php ENDPATH**/ ?>